...
- **Duración de cada partido:** 90 minutos de juego que transcurren en un tiempo real configurable al crear la temporada. Por ejemplo, 5 minutos reales por lado equivalen a 10 minutos reales en total; 2,5 minutos por lado equivalen a 5 minutos en total. El servidor controla ese reloj.
- **Tiempo por turno:** cada jugador tiene 15 segundos reales para patear. Si se agota, pierde el turno. Esta regla aplica en cualquier modo, no solo en Liga.
